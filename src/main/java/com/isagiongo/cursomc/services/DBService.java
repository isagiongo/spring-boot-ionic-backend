...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p13 = new Produto(null, "Computador", 2450.00);
		Produto p14 = new Produto(null, "Cadeira", 324.98);
		Produto p15 = new Produto(null, "Mouse", 29.90);
		Produto p16 = new Produto(null, "Papel A4", 9.40);
		Produto p17 = new Produto(null, "Mesa Redonda", 123.66);
		Produto p18 = new Produto(null, "Playstation 4", 999.99);
		Produto p19 = new Produto(null, "Caderno 200 folhas", 21.90);
		Produto p20 = new Produto(null, "Fone bluetooth", 29.90);
		Produto p21 = new Produto(null, "Caixa de Som", 9.40);
		Produto p22 = new Produto(null, "Espelho", 123.66);
		Produto p23 = new Produto(null, "Liquidificador", 999.99);
		Produto p24 = new Produto(null, "Agenda", 21.90);
		Produto p25 = new Produto(null, "Computador", 2450.00);
		Produto p26 = new Produto(null, "Cadeira", 324.98);
		Produto p27 = new Produto(null, "Mouse", 29.90);
		Produto p28 = new Produto(null, "Papel A4", 9.40);
		Produto p29 = new Produto(null, "Mesa Redonda", 123.66);
		Produto p30 = new Produto(null, "Playstation 4", 999.99);
		Produto p31 = new Produto(null, "Caderno 200 folhas", 21.90);
		Produto p32 = new Produto(null, "Fone bluetooth", 29.90);
		Produto p33 = new Produto(null, "Caixa de Som", 9.40);
		Produto p34 = new Produto(null, "Espelho", 123.66);
		Produto p35 = new Produto(null, "Liquidificador", 999.99);
		Produto p36 = new Produto(null, "Agenda", 21.90);

		cat1.getProdutos().addAll(Arrays.asList(p1, p2, p3, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p33, p34, p35, p36));
