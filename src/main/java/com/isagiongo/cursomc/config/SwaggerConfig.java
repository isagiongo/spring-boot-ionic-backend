package com.isagiongo.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.isagiongo.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Api construido em curso sobre Spring Boot", "Sistema de ecommerce simples",
				"Versão 1.0", "", new Contact("Isa Giongo","","isagiongo@gmail.com"),
				"Uso educacional", "", Collections.emptyList());
	}
