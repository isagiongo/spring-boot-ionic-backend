...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Papelaria'),(4,'Móveis'),(5,'Livros'),(6,'Música'),(7,'Beleza'),(8,'Eletroportáteis'),(9,'Games'),(10,'Telefonia'),(11,'teste');
...
INSERT INTO `cidade` VALUES (1,'Recife',1),(2,'Porto Alegre',2),(3,'Salvador',3),(4,'Belo Horizonte',4),(5,'Dourador',5),(6,'Torres',2);
...
INSERT INTO `cliente` VALUES (1,'89570260106','isa@gmail.com','Isadora Giongo',1),(2,'77785225142','veronica@gmail.com','Veronica Torres',1);
...
INSERT INTO `endereco` VALUES (1,'Petrópolis','90460155','Apt 32','Amelia Teles','120',2,1),(2,'Jardins','7052555','Casa 2','Alameda Jau','1890',4,1),(3,'Petrópolis','90460155','Apt 32','Amelia Teles','120',2,2);
...
INSERT INTO `estado` VALUES (1,'Pernambuco'),(2,'Rio Grande do Sul'),(3,'Bahia'),(4,'Minas Gerais'),(5,'Mato Grosso do Sul');
...
INSERT INTO `item_pedido` VALUES (15,2000,1,1,1),(29,80,2,1,3),(100,800,1,2,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2450),(2,'Cadeira',324.98),(3,'Mouse',29.9),(4,'Papel A4',9.4),(5,'Mesa Redonda',123.66),(6,'Playstation 4',999.99),(7,'Caderno 200 folhas',21.9),(8,'Fone bluetooth',29.9),(9,'Caixa de Som',9.4),(10,'Espelho',123.66),(11,'Liquidificador',999.99),(12,'Agenda',21.9);
...
INSERT INTO `produto_categoria` VALUES (1,1),(1,3),(1,6),(2,1),(2,2),(3,1),(3,8),(3,9),(4,3),(4,4),(5,5),(5,8),(6,4),(7,5),(8,5),(8,7),(9,7),(10,6),(10,7),(11,7),(11,9),(11,10),(12,7),(12,10);
...
INSERT INTO `telefone` VALUES (1,'9988-88889'),(1,'3333-0000'),(2,'98764-3322');
...
-- Dump completed on 2018-11-15 17:24:04
